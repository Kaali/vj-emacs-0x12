...
Maximize the frame as soon as possible.
...
I'm trying out [[https://github.com/raxod502/straight.el][straight.el]] for support reproducible builds, and also
to have the option of fetching newer versions of packages from git.

#+BEGIN_SRC emacs-lisp
  (defconst vj--use-straight-el t)
#+END_SRC

*** straight.el

#+BEGIN_SRC emacs-lisp
  (when vj--use-straight-el
...
#+BEGIN_SRC emacs-lisp
  ...
  ;(unless (and (not vj--use-straight-el) (featurep 'use-package))
...
#+BEGIN_SRC emacs-lisp
  ...
  (set-frame-font (font-candidate "Input-13" "Noto Mono-9" "DejaVu Sans Mono-9" "Consolas-9") nil t)
