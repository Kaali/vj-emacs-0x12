...
#+BEGIN_SRC emacs-lisp
  ...
  (set-frame-font (font-candidate "Input-13" "DejaVu Sans Mono-9" "Consolas-9"))
...
They are actually released as three packages, and to setup the
autoloads, they have to be required.

#+BEGIN_SRC emacs-lisp
  (use-package gitconfig-mode
    :config (require 'gitconfig-mode))

  (use-package gitattributes-mode
    :config (require 'gitattributes-mode))

  (use-package gitignore-mode
    :config (require 'gitignore-mode))
#+END_SRC
