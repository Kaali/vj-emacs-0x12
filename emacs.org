...
Use a proper [[https://github.com/joshwnj/json-mode][json-mode]] instead of =js2-mode=. Prettier colors and a
formatter.
...
you don't actually need indexing. It's setup after smart-jump as that is the
tool I use it from.
